...
function display_products($arr){
	...
	if (isset($_GET["di"])) {
		echo "<div class=\"w3-row w3-padding-64 w3-animate-right\">";
		echo"<div class=\"w3-col m3 l2 w3-container\">
				    <img class=\"img-responsive w3-circle w3-card w3-hover-shadow\" src=\"assets/images/pro/".$arr->img."\" style=\"width:130px;height:130px;cursor:pointer\" onclick=\"Assistant('".$arr->id."')\">
		...
		foreach ($arr as $ar){
			echo"<div class=\"w3-col m3 l3\">
				    <img class=\"img-responsive w3-circle w3-card w3-hover-shadow\" src=\"assets/images/pro/".$ar->img."\" style=\"width:150px;height:150px;cursor:pointer\" onclick=\"Assistant('".$ar->id."')\">
