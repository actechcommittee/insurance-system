...
<body style="background: url('./assets/images/bg.jpg') no-repeat center center fixed;
  ...
  <div class="w3-padding-32 pane" role="tablist" aria-multiselectable="true" id="accordion">
      ...
      <div class="w3-panel w3-padding-8 w3-text-white" type="button" id="accord" data-parent="#accordion" style="cursor: pointer;background-color: #880000;">
      ...
      <div class="w3-panel w3-padding-8 w3-text-white clickable" type="button" data-toggle="collapse" data-target="#collapseExample2" data-parent="#accordion" id="accord" style="cursor: pointer;background-color: #880000;">
        About Actuarial Science
        <!-- <span class="w3-right"><i class="glyphicon glyphicon-plus"></i></span> -->
      </div>
   </div>
